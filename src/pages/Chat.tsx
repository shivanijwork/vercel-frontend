...
const Chat = () => {
  ...
  const handleSubmit = async () => {
    ...
    setChatMessages(
      chatData.chats.map((chat: { role: string; content: any }) => ({
...
//            <Avatar sx={{mx:"auto", my: 2, bgcolor: "white", color:"black", fontWeight: 700}}>{auth?.user?.name[0]}
//             {auth?.user?.name.split(" ")[1][0]}</Avatar>
//             <Typography sx ={{mx:"auto", fontFamily: "work sans"}}>You are talking to a ChatBot</Typography>
//             <Typography sx ={{mx:"auto", fontFamily: "work sans", my:4, p:3}}>You can ask questions related to technology, business, life etc. But avoid sharing personal information</Typography>
